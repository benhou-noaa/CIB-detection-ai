...
model.save_weights(os.path.join(model_dir, "-".join([model_name, 'ResNet50_weights_all_data.h5'])))

# Save the model architecture
with open(os.path.join(model_dir, "-".join([model_name, 'ResNet50_architecture_all_data.json'])), 'w') as f:
