...
model.save_weights(os.path.join(model_dir, "-".join([model_name, 'vgg16_weights_all_data.h5'])))

# Save the model architecture
with open(os.path.join(model_dir, "-".join([model_name, 'vgg16_architecture_all_data.json'])), 'w') as f:
